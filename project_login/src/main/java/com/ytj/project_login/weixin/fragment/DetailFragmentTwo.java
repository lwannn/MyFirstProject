 ...
 */
public class DetailFragmentTwo {
...
//    private ArrayList<String> itemWorkMate;
    ...
    private DetailFragment.TitleConfiguration titleConfiguration;
...
//                    }
    ...
    public void onCreate(Context context, LayoutInflater inflater) {
        mRootView = inflater.inflate(R.layout.activity_detail, new FrameLayout(context), true);
    ...
    public void onResume() {
        isStart = true;
        context.stopService(netServiceIntent);
    }
...
//                            itemCase.add(i, cases.get(i).getName());
                        ...
                        MINE_ID = DetailActivity.MINE_ID;
