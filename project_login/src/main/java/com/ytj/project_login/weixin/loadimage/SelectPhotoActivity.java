package com.ytj.project_login.weixin.loadimage;
...
public class SelectPhotoActivity extends Activity implements SelectPhotoAdapter.CallBackActivity,View.OnClickListener{
    SelectPhotoAdapter allPhotoAdapter =  null;
    TextView tv_done;
    TextView tv_album_name;
    LinearLayout rl_album;
    ...
    private void initView(){
        ...
        //选择相册的布局
        rl_album = (LinearLayout) findViewById(R.id.rl_album);
        ...
        findViewById(R.id.view_cacle).setOnClickListener(this);
    ...
    public void updateSelectActivityViewUI() {
        if (allPhotoAdapter.selectedPhotosSet != null && allPhotoAdapter.selectedPhotosSet.size()>0) {
            tv_done.setTextColor(0xffffffff);
            tv_done.setClickable(true);
            tv_done.setEnabled(true);
            tv_done.setText("发送(" + allPhotoAdapter.selectedPhotosSet.size() + "/9)");
        } else {
            tv_done.setTextColor(0xffdbd9d9);
    ...
    void hideAlbum(){
        if(Build.VERSION.SDK_INT >=11) {
            ...
            ObjectAnimator animator3 = ObjectAnimator.ofFloat(rl_album, "translationY", dp2Px(0));
