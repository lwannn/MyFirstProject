...
//            });
    ...
    public void setSelectedItem(int index) {
        bottomItems[index].performClick();
    }

    public LinearLayout_lai[] getBottomItems() {
        return bottomItems;
    }

    public LinearLayout_lai getBottomItem(int index) {
        return bottomItems[index];
    }
