...
public class WithCheckBoxExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public WithCheckBoxExpandableListAdapter(Context context, ArrayList<String> groupType, ArrayList<ArrayList<String>> items) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childHolder.mChild.setText(items.get(groupPosition).get(childPosition));
